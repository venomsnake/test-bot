...
@Ceregay.on_message(command("approve") & admin_filter)
async def approve_user(c: Ceregay, m: Message):
...
async def disapprove_user(c: Ceregay, m: Message):
    db = Approve(m.chat.id)
...
@Ceregay.on_message(command("approved") & admin_filter)
...
@Ceregay.on_message(command("approval") & filters.group)
async def check_approval(c: Ceregay, m: Message):
    db = Approve(m.chat.id)
...
@Ceregay.on_callback_query(filters.regex("^unapprove_all$"))
