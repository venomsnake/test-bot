...
from Nibb.utils.cmd_senders import send_cmd
from Nibb.utils.custom_filters import admin_filter, command, owner_filter
from Nibb.utils.kbhelpers import ikb
from Nibb.utils.msg_types import Types, get_note_type
from Nibb.utils.string import (build_keyboard,
...
@Ceregay.on_message(command("save") & admin_filter & ~filters.bot)
...
async def get_note_func(c: Ceregay, m: Message, note_name, priv_notes_status):
...
async def get_raw_note(c: Ceregay, m: Message, note: str):
...
@Ceregay.on_message(filters.regex(r"^#[^\s]+") & filters.group & ~filters.bot)
async def hash_get(c: Ceregay, m: Message):
...
@Ceregay.on_message(command("get") & filters.group & ~filters.bot)
async def get_note(c: Ceregay, m: Message):
...
@Ceregay.on_message(command(["privnotes", "privatenotes"]) & admin_filter & ~filters.bot)
...
@Ceregay.on_message(command("notes") & filters.group & ~filters.bot)
...
@Ceregay.on_message(command("clear") & admin_filter & ~filters.bot)
...
@Ceregay.on_message(command("clearall") & owner_filter & ~filters.bot)
...
@Ceregay.on_callback_query(filters.regex("^clear_notes$"))
