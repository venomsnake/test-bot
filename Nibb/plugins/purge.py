...
@Ceregay.on_message(command("purge") & admin_filter)
async def purge(c: Ceregay, m: Message):
...
@Ceregay.on_message(command("spurge") & admin_filter)
async def spurge(c: Ceregay, m: Message):
...
async def del_msg(c: Ceregay, m: Message):
