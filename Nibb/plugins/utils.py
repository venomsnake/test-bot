...
@Ceregay.on_message(command("wiki"))
...
@Ceregay.on_message(command("gdpr"))
async def gdpr_remove(_, m: Message):
    ...
    await m.reply_text(
        ...
        "Note that this will not unban you from any chats, as that is telegram data, not Ceregay data."
...
async def id_info(c: Ceregay, m: Message):
...
@Ceregay.on_message(command("paste"))
...
**Example:**
`/git iamCeregayof6eyes`: this fetches the information about a user from the database."""
