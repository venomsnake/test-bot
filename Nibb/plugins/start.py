...
from Nibb import HELP_COMMANDS, LOGGER
from Nibb.bot_class import Ceregay
from Nibb.utils.custom_filters import command
from Nibb.utils.extras import StartPic
from Nibb.utils.kbhelpers import ikb
from Nibb.utils.start_utils import (gen_cmds_kb, gen_start_kb, get_help_msg,
...
@Ceregay.on_callback_query(filters.regex("^close_admin$"))
...
async def start(c: Ceregay, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        try:
            cpt = f"""
Hey [{m.from_user.first_name}](http://t.me/{m.from_user.username})! My self Ceregay ✨.
I'm here to help you manage your groups!
Hit /help to find out more about how to use me in my full potential!

Join my [News Channel](https://t.me/Ceregay_bots_network) to get information on all the latest updates."""
...
@Ceregay.on_callback_query(filters.regex("^start_back$"))
async def start_back(_, q: CallbackQuery):
    try:
        cpt = f"""
Hey [{q.from_user.first_name}](http://t.me/{q.from_user.username})! My name is Ceregay ✨.
I'm here to help you manage your groups!
Hit /help to find out more about how to use me in my full potential!

Join my [News Channel](http://t.me/Ceregay_bots_network) to get information on all the latest updates."""
...
@Ceregay.on_callback_query(filters.regex("^commands$"))
...
@Ceregay.on_message(command("help"))
async def help_menu(_, m: Message):
    if len(m.text.split()) >= 2:
        ...
        if m.chat.type == ChatType.PRIVATE:
            ...
            keyboard = ikb(ou, True)
            msg = f"""
Hey **[{m.from_user.first_name}](http://t.me/{m.from_user.username})**!My name is Ceregay✨.
I'm here to help you manage your groups!
Commands available:
× /start: Start the bot
× /help: Give's you this message."""
...
@Ceregay.on_callback_query(filters.regex("^plugins."))
async def get_module_info(c: Ceregay, q: CallbackQuery):
