...
from Nibb import DEV_USERS, LOGGER, OWNER_ID, SUDO_USERS, WHITELIST_USERS
...
@Ceregay.on_message(command("botstaff", dev_cmd=True))
async def botstaff(c: Ceregay, m: Message):
    try:
