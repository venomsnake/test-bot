...
@Ceregay.on_message(command("report") & filters.group)
async def report_watcher(c: Ceregay, m: Message):
...
@Ceregay.on_callback_query(filters.regex("^report_"))
async def report_buttons(c: Ceregay, q: CallbackQuery):
