...
from Nibb import LOGGER, SUPPORT_GROUP
...
from Nibb.utils.string import build_keyboard, parse_button


@Ceregay.on_message(command("pin") & admin_filter)
...
@Ceregay.on_message(command("unpin") & admin_filter)
async def unpin_message(c: Ceregay, m: Message):
    try:
        if m.reply_to_message:
...
@Ceregay.on_message(command("unpinall") & admin_filter)
...
@Ceregay.on_callback_query(regex("^unpin_all_in_this_chat$"))
async def unpinall_calllback(c: Ceregay, q: CallbackQuery):
...
@Ceregay.on_message(command("antichannelpin") & admin_filter)
...
@Ceregay.on_message(command("pinned") & admin_filter)
async def pinned_message(c: Ceregay, m: Message):
...
@Ceregay.on_message(command("cleanlinked") & admin_filter)
...
@Ceregay.on_message(command("permapin") & admin_filter)
