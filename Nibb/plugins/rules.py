...
@Ceregay.on_message(command("rules") & filters.group)
...
@Ceregay.on_message(command("setrules") & admin_filter)
...
@Ceregay.on_message(command("clearrules") & admin_filter)
...
@Ceregay.on_callback_query(filters.regex("^clear_rules$"))
