...
from Nibb.utils.custom_filters import command, owner_filter, restrict_filter
from Nibb.utils.kbhelpers import ikb


@Ceregay.on_message(command("blacklist") & filters.group)
...
@Ceregay.on_message(command("addblacklist") & restrict_filter)
...
@Ceregay.on_callback_query(filters.regex("^rm_allblacklist$"))
