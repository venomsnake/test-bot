...
from Nibb.utils.custom_filters import (admin_filter, can_change_filter,
                                         command, owner_filter)


@Ceregay.on_message(command("disable") & can_change_filter)
...
@Ceregay.on_message(command("disabledel") & can_change_filter)
...
@Ceregay.on_message(command("enable") & can_change_filter)
...
@Ceregay.on_message(command("disableable") & can_change_filter)
...
@Ceregay.on_message(command("disabled") & admin_filter)
...
@Ceregay.on_message(command("enableall") & owner_filter)
...
@Ceregay.on_callback_query(filters.regex("^enableallcmds$"))
