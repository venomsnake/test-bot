...
from Nibb import DB_NAME, DB_URI, LOGGER

try:
    Nibb_db_client = MongoClient(DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
Nibb_main_db = Nibb_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = Nibb_main_db[collection]
